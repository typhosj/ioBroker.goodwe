...
const registerGroups = {
    deviceInfo: {
        ...
        entries: [
            ...
            entry(35016, "DeviceInfo.DSP1_SW_Version", "DSP1_SoftwareVersion", TYPE.U16),
            entry(35017, "DeviceInfo.DSP2_SW_Version", "DSP2_SoftwareVersion", TYPE.U16),
            entry(35018, "DeviceInfo.DSP_SVN_Version", "DSP_SVN_Version", TYPE.U16),
            entry(35019, "DeviceInfo.ARM_SW_Version", "ARM_SoftwareVersion", TYPE.U16),
            entry(35020, "DeviceInfo.ARM_SVN_Version", "ARM_SVN_Version", TYPE.U16),
            entry(35021, "DeviceInfo.DSP_Int_FW_Version", "DSP_IntFirmwareVersion", TYPE.STRING, { registers: 6 }),
            entry(35027, "DeviceInfo.ARM_Int_FW_Version", "ARM_IntFirmwareVersion", TYPE.STRING, { registers: 6 }),
        ],
    },
    runningData: {
        name: "RunningData",
        ...
        entries: [
            ...
            entry(35119, "RunningData.PV4.Mode", "Pv4.Mode", TYPE.BYTE, {
                byteOffset: 0,
                states: status_definitions_1.valueStates.pvMode,
            }),
            ...
            entry(35123, "RunningData.GridL1.Frequency", "GridL1.Frequency", TYPE.U16, { scale: 100, unit: "Hz" }),
            ...
            entry(35128, "RunningData.GridL2.Frequency", "GridL2.Frequency", TYPE.U16, { scale: 100, unit: "Hz" }),
            ...
            entry(35133, "RunningData.GridL3.Frequency", "GridL3.Frequency", TYPE.U16, { scale: 100, unit: "Hz" }),
            entry(35135, "RunningData.GridL3.Power", "GridL3.Power", TYPE.S16, {
                unit: "W",
            }),
            entry(35136, "RunningData.GridMode", "GridMode", TYPE.U16, {
                states: status_definitions_1.valueStates.gridStatus,
            }),
            entry(35138, "RunningData.InverterTotalPower", "InverterTotalPower", TYPE.S16, { unit: "W" }),
            ...
            entry(35145, "RunningData.BackUpL1.Voltage", "BackUpL1.Voltage", TYPE.U16, { scale: 10, unit: "V" }),
            entry(35146, "RunningData.BackUpL1.Current", "BackUpL1.Current", TYPE.U16, { scale: 10, unit: "A" }),
            entry(35147, "RunningData.BackUpL1.Frequency", "BackUpL1.Frequency", TYPE.U16, { scale: 100, unit: "Hz" }),
            entry(35148, "RunningData.BackUpL1.Mode", "BackUpL1.Mode", TYPE.U16, {
                states: status_definitions_1.valueStates.backupStatus,
            }),
            entry(35150, "RunningData.BackUpL1.Power", "BackUpL1.Power", TYPE.S16, {
                unit: "W",
            }),
            entry(35151, "RunningData.BackUpL2.Voltage", "BackUpL2.Voltage", TYPE.U16, { scale: 10, unit: "V" }),
            entry(35152, "RunningData.BackUpL2.Current", "BackUpL2.Current", TYPE.U16, { scale: 10, unit: "A" }),
            entry(35153, "RunningData.BackUpL2.Frequency", "BackUpL2.Frequency", TYPE.U16, { scale: 100, unit: "Hz" }),
            ...
            entry(35157, "RunningData.BackUpL3.Voltage", "BackUpL3.Voltage", TYPE.U16, { scale: 10, unit: "V" }),
            entry(35158, "RunningData.BackUpL3.Current", "BackUpL3.Current", TYPE.U16, { scale: 10, unit: "A" }),
            entry(35159, "RunningData.BackUpL3.Frequency", "BackUpL3.Frequency", TYPE.U16, { scale: 100, unit: "Hz" }),
            ...
            entry(35170, "RunningData.TotalPowerBackUp", "TotalPowerBackUp", TYPE.S16, { unit: "W" }),
            ...
            entry(35180, "RunningData.Battery1.Voltage", "Battery1.Voltage", TYPE.U16, { scale: 10, unit: "V" }),
            entry(35181, "RunningData.Battery1.Current", "Battery1.Current", TYPE.S16, { scale: 10, unit: "A" }),
            ...
            entry(35184, "RunningData.Battery1.Mode", "Battery1.Mode", TYPE.U16, {
                states: status_definitions_1.valueStates.batteryStatus,
            }),
            ...
            entry(35187, "RunningData.WorkMode", "WorkMode", TYPE.U16, {
                states: status_definitions_1.valueStates.workMode,
            }),
            entry(35188, "RunningData.OperationMode", "OperationMode", TYPE.U16, {
                states: status_definitions_1.valueStates.operationMode,
            }),
            ...
            entry(35206, "RunningData.EnergyBatteryCharge", "EnergyBatteryCharge", TYPE.U32, { scale: 10, unit: "kWh" }),
            entry(35208, "RunningData.EnergyDayCharge", "EnergyDayCharge", TYPE.U16, {
                scale: 10,
                unit: "kWh",
            }),
            entry(35209, "RunningData.EnergyBatteryDischarge", "EnergyBatteryDischarge", TYPE.U32, { scale: 10, unit: "kWh" }),
            entry(35211, "RunningData.EnergyDayDischarge", "EnergyDayDischarge", TYPE.U16, { scale: 10, unit: "kWh" }),
            ...
            entry(35216, "RunningData.DerateFrozenPower", "DerateFrozenPower", TYPE.S32, { unit: "W" }),
    ...
    extComData: {
        ...
        entries: [
            ...
            entry(36003, "ExtComData.MeterConnectStatus", "MeterConnectStatus", TYPE.U16),
            entry(36004, "ExtComData.MeterCommunicateStatus", "MeterCommunicateStatus", TYPE.U16),
            ...
            entry(36008, "ExtComData.TotalActivePower", "TotalActivePower", TYPE.S16, { unit: "W" }),
            entry(36009, "ExtComData.TotalReactivePower", "TotalReactivePower", TYPE.U16, { unit: "var" }),
            ...
            entry(36015, "ExtComData.EnergyTotalSell", "EnergyTotalSell", TYPE.FLOAT, { scale: 10, unit: "kWh" }),
    ...
    bmsInfo: {
        ...
        entries: [
            ...
            entry(37005, "BMSInfo.CurrentMaxDischarge", "CurrentMaxDischarge", TYPE.U16, { unit: "A" }),
    ...
    extComDataExtended: {
        ...
        entries: [
            ...
            entry(36023, "ExtComData.Extended.L3.ActivePower", "Extended.L3.ActivePower", TYPE.S32, { unit: "W" }),
            entry(36025, "ExtComData.Extended.TotalActivePower", "Extended.TotalActivePower", TYPE.S32, { unit: "W" }),
            entry(36027, "ExtComData.Extended.L1.ReactivePower", "Extended.L1.ReactivePower", TYPE.S32, { unit: "var" }),
            entry(36029, "ExtComData.Extended.L2.ReactivePower", "Extended.L2.ReactivePower", TYPE.S32, { unit: "var" }),
            entry(36031, "ExtComData.Extended.L3.ReactivePower", "Extended.L3.ReactivePower", TYPE.S32, { unit: "var" }),
            entry(36033, "ExtComData.Extended.TotalReactivePower", "Extended.TotalReactivePower", TYPE.S32, { unit: "var" }),
            entry(36035, "ExtComData.Extended.L1.ApparentPower", "Extended.L1.ApparentPower", TYPE.S32, { unit: "VA" }),
            entry(36037, "ExtComData.Extended.L2.ApparentPower", "Extended.L2.ApparentPower", TYPE.S32, { unit: "VA" }),
            entry(36039, "ExtComData.Extended.L3.ApparentPower", "Extended.L3.ApparentPower", TYPE.S32, { unit: "VA" }),
            entry(36041, "ExtComData.Extended.TotalApparentPower", "Extended.TotalApparentPower", TYPE.S32, { unit: "VA" }),
            entry(36043, "ExtComData.Extended.MeterType", "Extended.MeterType", TYPE.U16),
            entry(36044, "ExtComData.Extended.MeterSoftwareVersion", "Extended.MeterSoftwareVersion", TYPE.U16),
        ],
    },
    flashInfo: {
        name: "FlashInfo",
        ...
        entries: [
            ...
            entry(36904, "FlashInfo.FlashSysWriteCount", "FlashSysWriteCount", TYPE.U32),
            entry(36906, "FlashInfo.FlashBatParaVer", "FlashBatParaVer", TYPE.U16),
            entry(36907, "FlashInfo.FlashBatWriteCount", "FlashBatWriteCount", TYPE.U32),
            entry(36909, "FlashInfo.FlashEepromVer", "FlashEepromVer", TYPE.U16),
            entry(36910, "FlashInfo.FlashEepromWriteCount", "FlashEepromWriteCount", TYPE.U32),
            entry(36912, "FlashInfo.WiFiDataSendCount", "WiFiDataSendCount", TYPE.U16),
    ...
    bmsInfoExtended: {
        ...
        entries: [
            ...
            entry(37016, "BMSInfo.MaximumCellTemperatureID", "MaximumCellTemperatureID", TYPE.U16),
    ...
    bmsDetail: {
        ...
        entries: [
            ...
            entry(37104, "BMSDetail.AllowDischargePower", "AllowDischargePower", TYPE.U32, { unit: "W" }),
            entry(37106, "BMSDetail.RelayStatus", "RelayStatus", TYPE.U16),
            entry(37107, "BMSDetail.BatteryModuleNumber", "BatteryModuleNumber", TYPE.U16),
            entry(37108, "BMSDetail.ShutdownFaultCode", "ShutdownFaultCode", TYPE.U16),
            entry(37109, "BMSDetail.BatteryReadyEnable", "BatteryReadyEnable", TYPE.U16),
            entry(37110, "BMSDetail.AlarmUnderTemperatureID", "AlarmUnderTemperatureID", TYPE.U16),
            entry(37111, "BMSDetail.AlarmOverTemperatureID", "AlarmOverTemperatureID", TYPE.U16),
            entry(37112, "BMSDetail.AlarmDifferTemperatureID", "AlarmDifferTemperatureID", TYPE.U16),
            entry(37113, "BMSDetail.AlarmChargeCurrentID", "AlarmChargeCurrentID", TYPE.U16),
            entry(37114, "BMSDetail.AlarmDischargeCurrentID", "AlarmDischargeCurrentID", TYPE.U16),
            entry(37115, "BMSDetail.AlarmCellOverVoltageID", "AlarmCellOverVoltageID", TYPE.U16),
            entry(37116, "BMSDetail.AlarmCellUnderVoltageID", "AlarmCellUnderVoltageID", TYPE.U16),
            entry(37117, "BMSDetail.AlarmSOCLowerID", "AlarmSOCLowerID", TYPE.U16),
            entry(37118, "BMSDetail.AlarmCellVoltageDifferID", "AlarmCellVoltageDifferID", TYPE.U16),
            ...range(1, 8).map((number) => entry(37118 + number, `BMSDetail.Battery${number}.Current`, `Battery${number}.Current`, TYPE.S16, {
                scale: 10,
                unit: "A",
            })),
            ...range(1, 8).map((number) => entry(37126 + number, `BMSDetail.Battery${number}.SOC`, `Battery${number}.SOC`, TYPE.U16, {
                unit: "%",
                role: "value.battery",
            })),
            ...range(1, 8).map((number) => entry(37133 + number * 2, `BMSDetail.Battery${number}.SN`, `Battery${number}.SN`, TYPE.U32)),
        ],
    },
    ceiAutoTest: {
        name: "CEIAutoTest",
    ...
    powerLimit: {
        ...
        entries: [
            ...
            entry(38454, "PowerLimit.InverterPowerFactor", "InverterPowerFactor", TYPE.S16, { scale: 1000 }),
            entry(38455, "PowerLimit.PVMeterDCPower", "PVMeterDCPower", TYPE.S32, {
                unit: "W",
            }),
            entry(38457, "PowerLimit.EtotalGridCharge", "EtotalGridCharge", TYPE.U32, { scale: 10, unit: "kWh" }),
...
function ceiLineEntries(line, start) {
    ...
    return [
        ...
        entry(start + 4, `${prefix}.AvgFaultValue`, `${model}.AvgFaultValue`, TYPE.U16, {
            scale: 10,
            unit: "V",
        }),
        entry(start + 5, `${prefix}.AvgFaultTime`, `${model}.AvgFaultTime`, TYPE.U16, {
            unit: "s",
        }),
        entry(start + 6, `${prefix}.VHighFaultValue`, `${model}.VHighFaultValue`, TYPE.U16, {
            scale: 10,
            unit: "V",
        }),
        entry(start + 7, `${prefix}.VHighFaultTime`, `${model}.VHighFaultTime`, TYPE.U16, {
            unit: "ms",
        }),
        entry(start + 8, `${prefix}.VLowFaultValueS1`, `${model}.VLowFaultValueS1`, TYPE.U16, {
            scale: 10,
            unit: "V",
        }),
        entry(start + 9, `${prefix}.VLowFaultTimeS1`, `${model}.VLowFaultTimeS1`, TYPE.U16, {
            unit: "ms",
        }),
        entry(start + 10, `${prefix}.VLowFaultValueS2`, `${model}.VLowFaultValueS2`, TYPE.U16, {
            scale: 10,
            unit: "V",
        }),
        entry(start + 11, `${prefix}.VLowFaultTimeS2`, `${model}.VLowFaultTimeS2`, TYPE.U16, {
            unit: "ms",
        }),
        entry(start + 12, `${prefix}.FHighFaultValueCom`, `${model}.FHighFaultValueCom`, TYPE.U16, {
            scale: 100,
            unit: "Hz",
        }),
        entry(start + 13, `${prefix}.FHighFaultTimeCom`, `${model}.FHighFaultTimeCom`, TYPE.U16, {
            unit: "ms",
        }),
        entry(start + 14, `${prefix}.FLowFaultValueCom`, `${model}.FLowFaultValueCom`, TYPE.U16, {
            scale: 100,
            unit: "Hz",
        }),
        entry(start + 15, `${prefix}.FLowFaultTimeCom`, `${model}.FLowFaultTimeCom`, TYPE.U16, {
            unit: "ms",
        }),
        entry(start + 16, `${prefix}.FHighFaultValue`, `${model}.FHighFaultValue`, TYPE.U16, {
            scale: 100,
            unit: "Hz",
        }),
        entry(start + 17, `${prefix}.FHighFaultTime`, `${model}.FHighFaultTime`, TYPE.U16, {
            unit: "ms",
        }),
        entry(start + 18, `${prefix}.FLowFaultValue`, `${model}.FLowFaultValue`, TYPE.U16, {
            scale: 100,
            unit: "Hz",
        }),
        entry(start + 19, `${prefix}.FLowFaultTime`, `${model}.FLowFaultTime`, TYPE.U16, {
            unit: "ms",
        }),
    ];
}
